...
export const LinkCard = ({
  ...
  return (
    <Link
      href={link}
      target="_blank"
      className="hover:bg-zinc-400/ group relative overflow-hidden rounded-xl border border-zinc-200 hover:border-zinc-800/50 dark:border-zinc-600 dark:hover:border-zinc-400/50 dark:hover:bg-zinc-800/10 md:gap-8"
    >
